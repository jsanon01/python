...
I want a main function to call: dept(), capital(), cities(), towns()

I want 'Dept of Grand-Anse' to be called when x = 1
I want 'Dept of Grand-Anse' to be called when x = 2
I want 'Dept of Grand-Anse' to be called when x = 3
I want 'Dept of Grand-Anse' to be called when x = 4
